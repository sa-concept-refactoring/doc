...
A refactoring would be really useful that generates a new concept declaration based on an existing function template declaration.
It would allow authors to more easily write comprehensive concepts without having to analyze their code in detail.
