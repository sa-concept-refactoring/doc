...
In @outlook it is described how this project could be extended and how the future of the language server looks like.
...
== Learnings <learnings>
Overall this project was very interesting and an enrichment working on an open source project like LLVM.
...
Finding a good structure for the documentation was hard and got changed many times.
...
As long as the C++ language is evolving the more refactorings can be added to help supporting the developers.
In case of this thesis an option would have been possible to switch between different forms of concepts.
